---
title: "Beast of Reincarnation Combat — Emma, Koo & the Hybrid System"
description: "What the official Combat Overview Trailer confirmed about Beast of Reincarnation's combat: Emma's swordplay, commanding Koo, and the real-time plus turn-based hybrid."
heading: "Combat Overview: How Emma and Koo Fight Together"
category: combat
keyword: "beast of reincarnation combat"
...
Beast of Reincarnation's combat is built around the bond between **Emma**, a human outcast, and **Koo**, a blighted dog. You do not control a character with a pet trailing behind — you fight as a **unit**. Emma handles direct swordplay in real time, while you issue **commands to Koo** to unleash his own techniques.

## A real-time plus turn-based hybrid

The single most distinctive thing Game Freak has confirmed is that this is a **hybrid combat system** fusing **real-time action with turn-based RPG elements**. That is the line that separates it from a straight Souls-like: moment-to-moment sword combat sits alongside a more deliberate, command-driven layer for Koo's abilities.

In practice that means two things to manage at once:
...
Fictions were explicit that the trailer was made to answer common questions asked on Steam and elsewhere about how the game plays. That framing matters: this is the developer's own attempt to define the combat, not a fan interpretation of a cinematic.

## Backed by hands-on previews
